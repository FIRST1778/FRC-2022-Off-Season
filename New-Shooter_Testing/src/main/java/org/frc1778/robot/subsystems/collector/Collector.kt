...
object Collector : FalconSubsystem() {
    ...
    private val miniRight = falconMAX(Constants.Collector.RIGHT_MINI_SLAVE, CANSparkMaxLowLevel.MotorType.kBrushless, DefaultNativeUnitModel) {
        brakeMode = true
        outputInverted = true
    }


    private val deployMotor = falconFX(Constants.Collector.DEPLOY_MOTOR, Constants.Collector.NATIVE_ROTATION_MODEL) {
        brakeMode = true
        outputInverted = false
